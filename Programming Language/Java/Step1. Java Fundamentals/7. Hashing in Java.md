...
15 % 5 = 0
22 % 5 = 2
as mentined in last step we can see the index 2 is already occupied by 12, so we will insert the element in the hash table at index 2 .
     22
     ||
     VV
15 _ 12 _ _
...
```
25 % 5 = 0
as mentined in last step we can see the index 0 is already occupied by 15, so we will insert the element in the hash table at index 0 .
25   22
||   ||
VV   VV
15 _ 12 _ _
